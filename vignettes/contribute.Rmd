...
* [Rnw2Rmd](https://github.com/Bioconductor/Rnw2Rmd)
...
13. If you have `pandoc` and `Rnw2Rmd` installed, you can utilize them for
    ...
    Note: Occasionally `Rnw2Rmd` has some` issues processing, so we'll have to
    manually correct these sections of the .Rmd file. You can refer to
    [converting the code chunks manually](#converting_manually) below.
