...
8. If you have `pandoc`, use it to preprocess. In the terminal: `pandoc -f latex -t markdown file.Rnw -o file.Rmd` (note: replace *file.Rnw* and *file.Rmd* with the name of the vignette you're converting).
