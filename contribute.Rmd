...
5. Fork the repository you will work on. #sceenshot if assume user not familiar with github
6. Clone your newly forked repository. #command if assume user not familiar
